...
//        System.out.println(args);
        ...
        if (args.containsKey("incoming") && !args.get("incoming").isEmpty()) {
            ...
            out.addSoftKeyItem("take_call","Annehmen",phoneproxy.PhoneProxy.getServer().getAddressString().concat("/call?info=1"));
        }
        if (args.containsKey("answered") && !args.get("answered").isEmpty()) {
            ...
            out.addSoftKeyItem("info","Info",phoneproxy.PhoneProxy.getServer().getAddressString().concat("/call?info=1"));
        }
